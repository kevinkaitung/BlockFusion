...
encoder_dims =         [32, 64, 64, 64, 64, 128, 128, 128, 256, 256, 256, 512, 1024, 1024, 2048, 1024, 1024, 512, 256, 256, 256, 128, 128, 128, 64, 64, vae_config["z_shape"][0]]
feature_size_encoder = [32, 32, 16, 16, 16,  8,   8,   8,   4,   4,   4,   2,   2,     2,    1,    2,    2,   2,   4,   4,   4,   8,   8,   8,  16, 16, 16]
...
fpn_encoders_layer_dim_idx = [2, 5, 8]
...
block_config = {
    "encoders_down": [
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[6], "inter_channels":encoder_dims[7], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[9], "inter_channels":encoder_dims[10], "stride":1,
