# Note: model config created at 5/22
...
encoder_dims =         [32, 64, 64, 64, 128, 128, 128, 256, 256, 256, 512, 1024, 1024, 2048, 1024, 1024, 512, 256, 256, 256, 128, 128, 128, 64, 64, vae_config["z_shape"][0]]
feature_size_encoder = [32, 16, 16, 16,  8,   8,   8,   4,   4,   4,   2,   2,     2,    1,    2,    2,   2,   4,   4,   4,   8,   8,   8,  16, 16, 16]

# decoder_in_channels = 128
decoder_dims =         [64, 64, 64, 128, 128, 128, 256, 256, 256, 512, 1024, 1024, 2048, 1024, 1024, 512, 256, 256, 256, 128, 128, 128, 64, 64, 64, vae_config["plane_shape"][1]]
feature_size_decoder = [16, 16, 16,  8,   8,   8,   4,   4,   4,   2,    2,   2,    1,    2,    2,    2,   4,   4,   4,   8,   8,   8,  16, 16, 16, vae_config["plane_shape"][2]]
...
block_config = {
    "encoders_down": [
                        ...
                        {"in_channels":encoder_dims[2], "inter_channels":encoder_dims[3], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[4], "inter_channels":encoder_dims[5], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[8], "inter_channels":encoder_dims[9], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[10], "inter_channels":encoder_dims[11], "stride":1,
                        "out_channels":encoder_dims[11], "feature_size":feature_size_encoder[11], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[11], "inter_channels":encoder_dims[12], "stride":1,
                        "out_channels":encoder_dims[12], "feature_size":feature_size_encoder[12], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":encoder_dims[12], "inter_channels":encoder_dims[13], "stride":2,
    ...
    "encoders_up": [
                    ...
                    {"in_channels":encoder_dims[14], "inter_channels":encoder_dims[15], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[15], "inter_channels":encoder_dims[16], "stride":1,
                        "out_channels":encoder_dims[16], "feature_size":feature_size_encoder[16], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[16], "inter_channels":encoder_dims[17], "stride":2,
                        "out_channels":encoder_dims[17], "feature_size":feature_size_encoder[17], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[17], "inter_channels":encoder_dims[18], "stride":1,
                        "out_channels":encoder_dims[18], "feature_size":feature_size_encoder[18], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[18], "inter_channels":encoder_dims[19], "stride":1,
                        "out_channels":encoder_dims[19], "feature_size":feature_size_encoder[19], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[19]*2, "inter_channels":encoder_dims[20], "stride":2,
                        "out_channels":encoder_dims[20], "feature_size":feature_size_encoder[20], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[20], "inter_channels":encoder_dims[21], "stride":1,
                        "out_channels":encoder_dims[21], "feature_size":feature_size_encoder[21], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[21], "inter_channels":encoder_dims[22], "stride":1,
                        "out_channels":encoder_dims[22], "feature_size":feature_size_encoder[22], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[22]*2, "inter_channels":encoder_dims[23], "stride":2,
                        "out_channels":encoder_dims[23], "feature_size":feature_size_encoder[23], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[23], "inter_channels":encoder_dims[24], "stride":1,
                        "out_channels":encoder_dims[24], "feature_size":feature_size_encoder[24], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":encoder_dims[24], "inter_channels":encoder_dims[25], "stride":1,
                    "out_channels":encoder_dims[25], "feature_size":feature_size_encoder[25], 
                    "use_transformer":False, "use_resblock":True, "is_decoder_output": False}
                    ],
    "decoders_down": [
                    {"in_channels":decoder_dims[0], "inter_channels":decoder_dims[1], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[1], "inter_channels":decoder_dims[2], "stride":1,
                    ...
                    {"in_channels":decoder_dims[2], "inter_channels":decoder_dims[3], "stride":2,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[3], "inter_channels":decoder_dims[4], "stride":1,
                    ...
                    "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[6], "inter_channels":decoder_dims[7], "stride":1,
                        "out_channels":decoder_dims[7], "feature_size":feature_size_decoder[7], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[7], "inter_channels":decoder_dims[8], "stride":1,
                    ...
                    "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[10], "inter_channels":decoder_dims[11], "stride":1,
                        "out_channels":decoder_dims[11], "feature_size":feature_size_decoder[11], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":decoder_dims[11], "inter_channels":decoder_dims[12], "stride":2,
    ...
    "decoders_up": [
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[14], "inter_channels":decoder_dims[15], "stride":1,
                        "out_channels":decoder_dims[15], "feature_size":feature_size_decoder[15], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[15], "inter_channels":decoder_dims[16], "stride":2,
                        "out_channels":decoder_dims[16], "feature_size":feature_size_decoder[16], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[16], "inter_channels":decoder_dims[17], "stride":1,
                        "out_channels":decoder_dims[17], "feature_size":feature_size_decoder[17], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[17]*2, "inter_channels":decoder_dims[18], "stride":1,
                        "out_channels":decoder_dims[18], "feature_size":feature_size_decoder[18], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[18], "inter_channels":decoder_dims[19], "stride":2,
                        "out_channels":decoder_dims[19], "feature_size":feature_size_decoder[19], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[19], "inter_channels":decoder_dims[20], "stride":1,
                        "out_channels":decoder_dims[20], "feature_size":feature_size_decoder[20], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[20]*2, "inter_channels":decoder_dims[21], "stride":1,
                        "out_channels":decoder_dims[21], "feature_size":feature_size_decoder[21], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[21], "inter_channels":decoder_dims[22], "stride":2,
                        "out_channels":decoder_dims[22], "feature_size":feature_size_decoder[22], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[22], "inter_channels":decoder_dims[23], "stride":1,
                        "out_channels":decoder_dims[23], "feature_size":feature_size_decoder[23], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[23], "inter_channels":decoder_dims[24], "stride":1,
                        "out_channels":decoder_dims[24], "feature_size":feature_size_decoder[24], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[24], "inter_channels":decoder_dims[24], "stride":2,
                        "out_channels":decoder_dims[25], "feature_size":feature_size_decoder[25], 
