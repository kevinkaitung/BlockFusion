...
# improved from model_g to let more blocks to use residual layers
...
encoder_use_resblocks = [None, True, True, True, False, False, True, True, True]
...
decoder_use_resblocks = [None, True, True, True, False, False, True, True, True]
