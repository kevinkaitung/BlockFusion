...
# model_i_2 is used to compare to model_g by reducing some downsampling blocks in encoder
...
encoder_dims =         [128, 512, 768, 1024, 2048, 1024,  2 * vae_config["z_shape"][0]]
feature_size_encoder = [128,  64,  32,   16,    8,   16,  vae_config["z_shape"][1]]
