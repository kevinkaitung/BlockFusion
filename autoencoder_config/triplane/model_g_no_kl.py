# Note: model created at 8/10,
# same model architecture as model_a, just to align with the VAE refactor, 
# which let users specify which block to use transformer layer or residual layer
# and to specify the number of residual layers in a block

# setup VAE model hyperparameters
vae_config = {
            "kl_std": 0.25,
            # "kl_weight": 0.0001,
            "kl_weight": 0.0, # set actual kl_weight from triplane_VAE_training.py cmd args
...
encoder_use_resblocks = [None, True, False, False, False, False, False, False, True]
...
decoder_use_resblocks = [None, False, False, False, False, False, False, False, True]
