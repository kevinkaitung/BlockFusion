# Note: model config created at 5/20
...
encoder_dims =         [32, 64, 128, 256, 256, 512, 512, 1024, 512, 512, 256, 256, 128,  vae_config["z_shape"][0]]
feature_size_encoder = [32, 16,  8,   4,   4,   2,   2,   1,    2,   2,   4,   4,   8,  16]

# decoder_in_channels = 128
decoder_dims =         [32,  128, 256, 256, 512, 512, 1024, 512, 512, 256, 256, 128, 32, vae_config["plane_shape"][1]]
feature_size_decoder = [16,   8,   4,   4,   2,   2,   1,    2,   2,   4,   4,   8,  16, vae_config["plane_shape"][2]]
...
block_config = {
    ...
    "encoders_up": [
                    ...
                    {"in_channels":encoder_dims[10], "inter_channels":encoder_dims[11], "stride":1,
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":2*encoder_dims[11], "inter_channels":encoder_dims[12], "stride":2,
                        "out_channels":encoder_dims[12], "feature_size":feature_size_encoder[12], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                    {"in_channels":2*encoder_dims[12], "inter_channels":encoder_dims[13], "stride":2,
    ...
    "decoders_up": [
                    ...
                    # twice wider of input channels for FPN layer input
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":2*decoder_dims[11], "inter_channels":decoder_dims[12], "stride":2,
                        "out_channels":decoder_dims[12], "feature_size":feature_size_decoder[12], 
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":2*decoder_dims[12], "inter_channels":decoder_dims[12], "stride":2,
