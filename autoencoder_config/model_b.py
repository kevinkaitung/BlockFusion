...
# no fpn, no kl, add some non-downsample/upsample CNN layers
batch_size = 90
...
decoder_dims =         [32,  128, 256, 256, 512, 512, 1024, 512, 512, 256, 256, 128, 64, vae_config["plane_shape"][1]]
...
block_config = {
    ...
    "decoders_up": [
                    ...
                    # twice wider of input channels for FPN layer input
                        ...
                        "use_transformer":True, "use_resblock":False, "is_decoder_output": False},
                        {"in_channels":decoder_dims[12], "inter_channels":decoder_dims[12], "stride":2,
