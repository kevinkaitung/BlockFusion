...
if __name__ == "__main__":
    ...
    triplane_weights[50:51,triplane_idx:triplane_idx+1] = (triplane_weights[50:51,triplane_idx:triplane_idx+1] - triplane_weights[50:51,triplane_idx:triplane_idx+1].min()) / (triplane_weights[50:51,triplane_idx:triplane_idx+1].max() - triplane_weights[50:51,triplane_idx:triplane_idx+1].min())
    triplane_weights[50:51,triplane_idx:triplane_idx+1] = triplane_weights[50:51,triplane_idx:triplane_idx+1] * 2 - 1
    train_dataloader = torch.utils.data.DataLoader(
        LatentWeightDataset(
        triplane_weights[50:51,triplane_idx:triplane_idx+1],
